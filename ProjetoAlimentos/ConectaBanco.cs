...
namespace ProjetoAlimentos
{
    public class ConectaBanco
    {
        ...
        //----------- fim listaProdutos -----------------
        public bool insereItens(string descricao, double massa, double massa_balanca, int idproduto)
        {
            ...
            cmd.Parameters.AddWithValue("massa_balanca", massa_balanca);
        ...
        //--------- fim insere_consumo ---------------
        public bool insereAdm(string nome, string senha, int tipo)
        {
            MySqlCommand cmd = new MySqlCommand("insere_adm", conexao);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        //--------- fim insere_adm ---------------
        public DataSet listaProdutosMassaTotal()
        {
            MySqlCommand cmd = new MySqlCommand("lista_produtos_massa_total", conexao);
            cmd.CommandType = CommandType.StoredProcedure;
            try
            {
                conexao.Open();//abrindo a conexão;
